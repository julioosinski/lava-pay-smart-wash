      ...
      if (user) {
        ...
        try {
          ...
          if (directAdminAccess) {
            console.log("AuthRedirect: Direct admin access detected, redirecting to admin panel");
          ...
          if (userData?.contact_email === 'admin@smartwash.com') {
            console.log("AuthRedirect: admin@smartwash.com detected, redirecting to admin panel");
            navigate('/admin', { replace: true });
            return;
          }
          ...
          console.log("AuthRedirect: redirecting based on role:", userRole);
